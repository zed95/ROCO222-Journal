...
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Improved%20Commutator%20shape.JPG)
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Folded%20brush%20wires.JPG)
...
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Old%20Armature.png)
>A picture of the old armature design
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/New%20Armature.png)
...
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/New%20armature%20showing%20washers.JPG)
>A picture of the new armature design with the washers fitted.
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/New%20armature%20with%20coils.JPG)
>A picture of the new armature with coil windings.
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Turns%20tally.png)
...
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Shaft%20Support.png)
...
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Magnet%20holder%20dimenions.png)
> A picture of the diagram used to work out the required height of the magnet holders.
> 
>![alt text](https://github.com/zed95/ROCO222-Journal/blob/master/Magnet%20holders.png)
...
> 
> We have been provided with a circuit diagram according to which we must construct the encoder. Making the IR light source and the light detector wasnt hard, we just needed to solder the two onto the verboard. We have then moved onto testing the circuit. While testing I realised that I soldered the positive pin of the phototransistor to the negative pin of the LED and I wasnt getting any results. After I corrected the mistake, I tested the circuit again and everything was working as intended; we had a voltage drop (the voltage drop is not big, only about 80-100mV) when we covered the LED so that the IR light didnt reach the phototransistor and we could see the IR light from the LED when we took a photo using the phone.
> 
>![alt text](insert picture of the circuit diagram)
> Picture of the encoder circuit provided.
> 
>![alt text](insert picture of completed circuit)
> A oicture of our encoder circuit.
> 
>![alt text](Insert pictre of the IR light)
> Picture of the IR light being emitted.
> 
>![alt text](Insert picture of voltage comparison between light hitting the phototransistor and the light being covered by the hand)
> A picture of the voltage drop comparison when the IR light reaches the phototransistor and when it is blocked.
> 
